...
implementation {
				...
				if(TOS_NODE_ID == ROOT1){
 				...
 				call CC2420Config.setChannel(22);
	  			...
	  			if(TOS_NODE_ID == ROOT1){
				      ...
				      delay_fp=fopen("/Users/wangwenchen/github/paper1_lp_measure/delay.txt", "a");
 				...
 				if(TOS_NODE_ID < ROOT1 && TOS_NODE_ID!=1 && TOS_NODE_ID!=2 && TOS_NODE_ID!=3 && TOS_NODE_ID!=4 && TOS_NODE_ID!=5 && TOS_NODE_ID!=6){
 					res_fp=fopen("/Users/wangwenchen/github/paper1_lp_measure/result.txt", "a");
    ...
    void readTopoFile(){
	   	...
	   	topo_fp = fopen("/Users/wangwenchen/github/paper1_lp_measure/topology.txt", "r");
	   	if (topo_fp == NULL)
	       exit(EXIT_FAILURE);
